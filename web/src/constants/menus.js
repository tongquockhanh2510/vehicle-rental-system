...
export const RENTER_MENU = [
  ...
  { label: 'Đánh giá', to: '/app/reviews', icon: 'Star' },
...
export const ADMIN_MENU = [
  ...
  { label: 'Đơn đăng ký chủ xe', to: '/admin/owner-applications', icon: 'ClipboardCheck' },
  ...
  { label: 'Sức khỏe hệ thống', to: '/admin/system-health', icon: 'Activity' },
  { label: 'Nhật ký hệ thống', to: '/admin/system-logs', icon: 'ScrollText' },
  { label: 'Kiến trúc & DevOps', to: '/admin/architecture', icon: 'Network' },
  { label: 'Trung tâm AI Agent', to: '/admin/ai-agent', icon: 'Bot' }
];