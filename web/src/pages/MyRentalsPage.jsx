                            ...
                            <div key={rental._id} className="bg-white p-6 rounded-lg shadow-md">
                                <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-center">
                                    <div>
                                        ...
                                        <p className="font-bold text-lg truncate">{rental.vehicle_id}</p>
                                    </div>
                                    <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-center">
                                    <div>
                                        <p className="text-gray-600 text-sm">Hãng</p>
                                        <p className="font-bold text-lg truncate">{rental.brand}</p>
                                    </div>
                                    <div>
                                        <p className="text-gray-600 text-sm">Model</p>
                                        <p className="font-semibold">{rental.model}</p>
                                    </div>
                                    <div>
                                        <p className="text-gray-600 text-sm">Năm</p>
                                        <p className="font-semibold">{rental.year}</p>
                                    </div>
                                    <div>
                                        <p className="text-gray-600 text-sm">Biển số</p>
                                        <div>{rental.license_plate}</div>
                                    </div>
                                </div>
                                <div className="mb-4">
