...
function resolveReturnLocation(vehicle) {
  ...
  const cityDistrict = [vehicle.city, vehicle.district].filter(Boolean).join(', ');
  return vehicle.return_location || vehicle.pickup_location || cityDistrict || vehicle.allowed_region || 'Chưa cập nhật';
}
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-2xl border border-white/10 bg-slate-900/60 p-5">
            ...
            <div className="mt-4 grid gap-3 text-sm text-slate-200 md:grid-cols-2">
              ...
              <p>Thành phố: <span className="font-semibold text-white">{vehicle.city || 'Chưa cập nhật'}</span></p>
              <p>Quận/Huyện: <span className="font-semibold text-white">{vehicle.district || 'Chưa cập nhật'}</span></p>
