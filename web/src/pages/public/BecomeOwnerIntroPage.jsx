    ...
    <div className="space-y-6">
      ...
      <section className="grid gap-4 md:grid-cols-3">
        ...
        <article className="rounded-2xl border border-cyan-400/25 bg-cyan-500/10 p-4">
          ...
          <p className="mt-1 text-sm text-cyan-100">Mọi giao dịch có timeline hợp đồng, thanh toán cọc và quy trình inspection rõ ràng.</p>
        </article>
      ...
      <div className="rounded-2xl border border-white/10 bg-slate-900/60 p-5">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <Link to="/register" className="rounded-xl bg-cyan-500 px-4 py-2 text-sm font-semibold text-slate-950">Đăng ký tài khoản</Link>
