            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex gap-4 mb-6">
                    <button
                        ...
                        className={`px-6 py-3 rounded-lg font-bold transition ${activeTab === 'my'
                    ...
                    <button
                        ...
                        className={`px-6 py-3 rounded-lg font-bold transition ${activeTab === 'admin'
                            ? 'bg-blue-600 text-white'
                            : 'bg-white text-gray-700 border border-gray-300 hover:bg-gray-50'
                            }`}
                    >
                            ...
                            <div key={dispute._id} className="bg-white p-6 rounded-lg shadow-md">
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4">
                                        {dispute.pickup_images?.map((image, index) => (
                                            <div
                                                key={index}
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4">
                                        {dispute.return_images?.map((image, index) => (
                                            <div
                                                key={index}
                                                className="border rounded-lg overflow-hidden shadow-sm"
                                            >
